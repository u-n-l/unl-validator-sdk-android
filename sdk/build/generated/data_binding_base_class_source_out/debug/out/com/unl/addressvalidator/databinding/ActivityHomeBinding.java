...
public final class ActivityHomeBinding implements ViewBinding {
  ...
  @NonNull
  public final CardView cvPinEnableDisable;
  ...
  @NonNull
  public final AppCompatImageView ivMovePin;
  ...
  private ActivityHomeBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull AddressListBinding addressesView, @NonNull AppCompatImageView backBtn,
      @NonNull RelativeLayout bottomDialog, @NonNull DialogAddressBinding confirmAddress,
      @NonNull View crossLine, @NonNull CardView cvPinEnableDisable, @NonNull CardView cvPintHint,
      @NonNull RelativeLayout header, @NonNull AppCompatTextView headerTitle,
      @NonNull ImageView hidePinHint, @NonNull AppCompatImageView ivMovePin,
      @NonNull AppCompatImageView ivShowAddreess, @NonNull UnlMapView mapView,
      @NonNull DeliveryHoursPopupBinding operationalHours, @NonNull AppCompatTextView pinHint,
    ...
    this.cvPinEnableDisable = cvPinEnableDisable;
    this.cvPintHint = cvPintHint;
    this.header = header;
    this.headerTitle = headerTitle;
    this.hidePinHint = hidePinHint;
    this.ivMovePin = ivMovePin;
  ...
  public static ActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.crossLine;
      View crossLine = ViewBindings.findChildViewById(rootView, id);
      if (crossLine == null) {
        break missingId;
      }

      id = R.id.cvPinEnableDisable;
      CardView cvPinEnableDisable = ViewBindings.findChildViewById(rootView, id);
      if (cvPinEnableDisable == null) {
        break missingId;
      }
      ...
      id = R.id.ivMovePin;
      AppCompatImageView ivMovePin = ViewBindings.findChildViewById(rootView, id);
      if (ivMovePin == null) {
        break missingId;
      }
      ...
      return new ActivityHomeBinding((ConstraintLayout) rootView, binding_addEntrances,
          binding_addLandmark, binding_addNewAdd, binding_addPicture, binding_addressesView,
          backBtn, bottomDialog, binding_confirmAddress, crossLine, cvPinEnableDisable, cvPintHint,
          header, headerTitle, hidePinHint, ivMovePin, ivShowAddreess, mapView,
          binding_operationalHours, pinHint, progressBar);
    }
