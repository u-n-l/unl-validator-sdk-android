...
import com.unl.addressvalidator.databinding.ActivityGalleryBinding
import com.unl.addressvalidator.ui.imagepicker.adapter.ImagesAdapter
import com.unl.addressvalidator.ui.imagepicker.model.ImageModel
    ...
    private fun getImagesUri(): MutableList<ImageModel>{
        ...
        query?.use { cursor ->
            ...
            while (cursor.moveToNext()) {
                ...
                Log.d("ContentURI", "getImagesUri============:  ${imageList.size}")
            }
        }
